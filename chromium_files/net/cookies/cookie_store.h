...
class NET_EXPORT CookieStore {
 public:
  ...
  virtual void GetAllCookiesExtAsync(GetAllCookiesCallback callback) = 0; // BrowserOnly
  ...
  virtual void GenerateReport(const CanonicalCookie cc,
		              std::string* header) = 0; // BrowserOnly
