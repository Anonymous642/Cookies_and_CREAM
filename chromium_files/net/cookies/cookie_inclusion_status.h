...
class NET_EXPORT CookieInclusionStatus {
 public:
  ...
  enum ExclusionReason {
    ...
    // Browser only cookie accessed by script or extensions
    EXCLUDE_BROWSER_ONLY = 27,  //BrowserOnly - added new exclusion reasons for ease of reporting 
    EXCLUDE_OVERWRITE_BROWSER_ONLY = 28,
