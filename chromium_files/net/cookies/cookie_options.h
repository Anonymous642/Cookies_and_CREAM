...
class NET_EXPORT CookieOptions {
 public:
  ...
  // BrowserOnly - tie browseronly exclusion behavior to httponly for easier updates to apis as there behaviors are the same in all 
  // but a subset of calls
  void set_exclude_httponly() { exclude_httponly_ = true; 
                                exclude_browseronly_ = true; }
  void set_include_httponly() { exclude_httponly_ = false; 
                                exclude_browseronly_ = false; }
  bool exclude_httponly() const { return exclude_httponly_; }

  // BrowserOnly - add the setters for excluding browseronly cookies 
  void set_exclude_browseronly() { exclude_browseronly_ = true; }
  void set_include_browseronly() { exclude_browseronly_ = false; }
  bool exclude_browseronly() const { return exclude_browseronly_; }
  ...
  static CookieOptions MakeMostInclusive();
 ...
 private:
  ...
  bool exclude_browseronly_ = true; // BrowserOnly - add browser only exclusion capabilities and default it to true
};
