...
std::string CookieInclusionStatus::GetDebugString() const {
  ...
  constexpr std::pair<ExclusionReason, const char*> exclusion_reasons[] = {
      ...
      {EXCLUDE_BROWSER_ONLY, "EXCLUDE_BROWSER_ONLY"}, //BrowserOnly - added new exclusion reasons for ease of reporting
      {EXCLUDE_OVERWRITE_BROWSER_ONLY, "EXCLUDE_OVERWRITE_BROWSER_ONLY"}
  };
  static_assert(
