...
class NET_EXPORT CookieMonster : public CookieStore {
 public:
  ...
  void GetAllCookiesExtAsync(GetAllCookiesCallback callback) override; //BrowserOnly
  ...
  void GenerateReport(const CanonicalCookie cc,
 ...
 private:
  ...
  void GetAllCookiesExt(GetAllCookiesCallback callback);
  ...
  void MaybeDeleteEquivalentCookieAndUpdateStatus(
      ...
      bool skip_httponly,
      bool skip_browseronly, //BrowserOnly
