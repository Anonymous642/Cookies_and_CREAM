...
// BrowserOnly - Enum for the monitored cookie options including the optional counts
enum CookieMonitored {
  Cookie_Monitored_HIGH_COUNT = 0,
  Cookie_Monitored_HIGH = 1,
  Cookie_Monitored_LOW_COUNT = 2, 
  Cookie_Monitored_LOW = 3,
  Cookie_Monitored_NONE = 4
};
...
NET_EXPORT std::string CookieMonitoredToString(CookieMonitored monitor);
NET_EXPORT CookieMonitored StringToCookieMonitored(const std::string& monitor);
