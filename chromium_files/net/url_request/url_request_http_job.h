...
class NET_EXPORT_PRIVATE URLRequestHttpJob : public URLRequestJob {
 ...
 private:
  ...
  void SetTesterRecursive(const CookieOptions& options,
 ...
 void SetTesterBlank(const CookieOptions& options,
                     absl::optional<CanonicalCookie> cookie,
                     std::string cookie_string,
                     CookieAccessResult access_result);

  void SetTester(const CookieOptions& options,
                 std::chrono::high_resolution_clock::time_point start,
                 absl::optional<CanonicalCookie> cookie,
                 std::string cookie_string,
                 CookieAccessResult access_result);

  void GetTester(const CookieOptions& options,
                 std::chrono::high_resolution_clock::time_point start,
  ...
  void OnSetCookieResult(const CookieOptions& options,
                         ...
                         std::string cookie_string,
                         CookieAccessResult access_result);
  // BrowserOnly - the needed lists for the attributes
  std::vector<CanonicalCookie> monitored_cookies_sent;
  std::vector<std::string> monitored_cookies_received;
  std::vector<std::string> browser_cookies_received;
  std::string full_cookie_line = "";
