...
// BrowserOnly - Implement the new method
void CookieManager::GetAllCookiesExt(GetAllCookiesCallback callback) {
  cookie_store_ ->GetAllCookiesExtAsync(std::move(callback));
}
