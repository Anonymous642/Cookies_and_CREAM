...
bool StructTraits<network::mojom::CookieOptionsDataView, net::CookieOptions>::
  ...
  // BrowserOnly - add new option to the interface 
  if (mojo_options.exclude_browseronly())
    cookie_options -> set_exclude_browseronly();
  else
    cookie_options -> set_include_browseronly();
