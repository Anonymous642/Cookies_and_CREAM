    ...
    document.addEventListener("DOMContentLoaded", (event) => {
        ...
        document.getElementById("saveConf").addEventListener("click", (event) => {
            ...
            if (target == ""){
                ...
                if (beforeGet){
                    browser.runtime.sendMessage({func: "beforeGet", target: target});
                ...
                if (beforeSet){
                    ...
                    if (beforeName == "" || beforeValue == ""){
                        ...
                        browser.runtime.sendMessage({func: "beforeSet", target: target, name: beforeName, value: beforeValue});
                        document.getElementById("status").style.color = "green";
                        document.getElementById("status").innerText = "Rule Added";
                    }
                }
                if (headersGet){
                    browser.runtime.sendMessage({func: "headersGet", target: target});
                    document.getElementById("status").style.color = "green";
                    document.getElementById("status").innerText = "Rule Added";
                }
                if (headersSet){
                    ...
                    if (headersName == "" || headersValue == ""){
                       ...
                       browser.runtime.sendMessage({func: "headersSet", target: target, name: headersName, value: headersValue});
                       document.getElementById("status").style.color = "green";
                       document.getElementById("status").innerText = "Rule Added";
                   }
               }
